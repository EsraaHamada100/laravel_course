...
<html lang="en">
  <head>
    ...
    {{-- importing the css and js code from the resources
      note: you should run npm run dev in order for it to run --}}
  ...
  <body>
    ...
    {{-- Here I see if the session has a message of type success --}}
