          ...
          <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
            <form action="/register" method="POST" id="registration-form">
              ...
              <div class="form-group">
                ...
                {{-- value="{{old('username')}}" will keep the old values when there is something
                in data is wrong so the user doesn't have to write the data again --}}
                ...
                {{-- This will show the error message that laravel provide us with --}}
              ...
              <div class="form-group">
                ...
                @include('components.error', ["name"=>"password_confirmation"])
